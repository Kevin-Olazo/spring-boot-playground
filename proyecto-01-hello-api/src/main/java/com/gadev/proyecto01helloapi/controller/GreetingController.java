...
public class GreetingController {
    ...
    public String calcular(
        ...
        switch (op){
            case "sumar" -> resultado = n1 + n2;
            case "restar" -> resultado = n1 - n2;
            case "multiplicar" -> resultado = n1 * n2;
            case "dividir" ->
            {
                if (n1 == 0 || n2 == 0){
            ...
            default -> {
                return "Operación no valida. Usa: sumar, restar, multiplicar, dividir";
            }

        }

        return n1 + " " + op + " " + n2 + " = " + resultado;
