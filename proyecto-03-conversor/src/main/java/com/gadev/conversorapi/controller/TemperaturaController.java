...
import com.gadev.conversorapi.service.TemperaturaService;
...
@RestController
@RequestMapping("/api/convertir/temperatura")
public class TemperaturaController {
    ...
    public ResponseEntity<ConversionResponse> convertir(@RequestBody ConversionRequest request){
        return ResponseEntity.ok(temperaturaService.convertir(request));
    }
}
